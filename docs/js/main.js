...
function togglePause () {
	paused = !paused;
	document.getElementById("buttonPause").innerHTML = paused? "çƒê∂":"É|Å[ÉY";
}
function toggleRotate () {
	if (!controls) return;
	controls.autoRotate = !controls.autoRotate;
	document.getElementById("buttonRotate").innerHTML = controls.autoRotate? "é©ìÆâÒì]ON":"é©ìÆâÒì]OFF";
}
function capture () {
